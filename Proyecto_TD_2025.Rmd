  ...
  for (linea in lineas) {
    ...
    if (ticket_valido) {
      ...
      if (contador_lineas == 3) {
        ...
        # Contruimos la localidad con el resto de los trozos restantes, sería útil por ejemplo para "La Rioga".
        localidad <- ifelse(
          length(partes_3) >= 2,
          paste(partes_3[-1],
          collapse = " "),
      ...
      if (contador_lineas == 5) {
        ...
        # Comprueba que halla encontrado el op y solo extrae la parte númerica.
        op <- ifelse(
          !is.na(op_encontrado),
