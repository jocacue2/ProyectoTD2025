...
# Definimos las verduras y frutas para poder filtrar nuestro data frame.
VERDUFRUTA <- c("PLATANO", "BANANA", "PEPINO", "BERENJENA", "KIWI VERDE", "CALABACIN VERDE", "COLIFLOR", "MANGO", "ALCACHOFA", "MANZANA GOLDEN", "AGUACATE", "PATATA", "MANDARINA", "HABAS", "TOMATE CANARIO","TOMATE PERA", "LIMON", "PIMIENTO ROJO", "POLVORON GRANEL", "BERENJENA RAYADA GR", "PIMIENTO FREIR", "MELON PIEL SAPO", "TOMATE ENSALADA", "MELOCOTON AMARILLO", "PERA CONFERENCIA", "TOMATE NEGRO", "BROCOLI", "MANZANA GRANNY", "SANDIA BAJA SEMILLAS", "")
