  ...
  for (linea in lineas) {
    ...
    if (ticket_valido) {
      ...
      if (en_productos && !str_detect(linea, "TOTAL \\(€\\)")) {
        ...
        # Línea donde la descripción está en una línea y el resto (peso, precio, importe) en la siguiente.
        ...
        # Línea con descripción e importe directo (sin precio unitario).
